...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionErrorDetails> FlightNotFoundHandleException(FlightNotFoundException ex , WebRequest request){
    ...
    public ResponseEntity<ExceptionErrorDetails> RouteNotFoundHandleException(RouteNotFoundException ex , WebRequest request){
        ExceptionErrorDetails exceptionErrorDetails =
                new ExceptionErrorDetails(request.getDescription(false), ex.getMessage());
        return new ResponseEntity<>(exceptionErrorDetails,ex.getHttpStatus());
    }
